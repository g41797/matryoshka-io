# Matryoshka Zig — Pattern Catalog (008)

Versioned doc. Replaces [patterns-007.md](patterns-007.md).
Reusable idioms confirmed in the examples and the API reference.
Companion: [rules-009.md](rules-009.md) — what is mandatory.
...
Concrete templates for the "Observable by human" MUST rule. See [rules-009.md](rules-009.md).
...
## Safe polymorphic identification — Node path
