...
Io tasks
    ...
    ┌────────┼────────────┐
    │        │            │
Single-job  Coordinator  Resource-holding
...
A worked example makes this concrete. Picture a print server: a client submits a job, a spooler orders the jobs, a printer driver prints them.
