...
Instead of sharing application objects, move them.
...
A Master holds state.

It does work.

It talks through Mailboxes.

The whole architecture fits into four concepts: **Master, Item, Mailbox, Pool.**

Small enough to read in one sitting.

---

Can you model your application using only Masters, Mailboxes, and Pools?
