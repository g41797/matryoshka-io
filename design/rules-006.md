# Matryoshka Zig — Rules (006)

Versioned doc. Replaces [rules-005.md](rules-005.md).
...
Companion: [patterns-005.md](patterns-005.md) — reusable coding patterns.
...
6. After kitchen scripts pass: scan changed `.zig` files for patterns not yet in `patterns-005.md`.
...
The pattern catalog lives in [patterns-005.md](patterns-005.md).
