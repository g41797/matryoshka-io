...
- `matryoshka-api-reference-002.md` — clean API reference, source of truth for implementation (Proposal 8, created 2026-06-20; updated 2026-06-23 with Proposal 27: Slot/NodeHandle rename)
...
- Synchronous `mbox.receive` takes `m: *Slot` — pointer to caller's stack variable
...
| 8 | API reference document | matryoshka-api-reference-002.md is source of truth |
