...
For architecture and rationale → `matryoshka-architecture-foundation-4-004.md`.
...
See `matryoshka-architecture-foundation-4-004.md` for the rationale.
...
For the rationale see `matryoshka-architecture-foundation-4-004.md`, section 10.
